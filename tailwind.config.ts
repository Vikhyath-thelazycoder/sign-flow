  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-up-fade": "slide-up-fade 0.6s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "letter-reveal": "letter-reveal 0.6s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "scale-in": "scale-in 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "shimmer": "shimmer 2s linear infinite",
      },
      boxShadow: {
        "glow-sm": "0 0 20px hsl(var(--primary) / 0.3)",
        "glow-md": "0 0 40px hsl(var(--primary) / 0.4)",
        "glow-lg": "0 0 60px hsl(var(--primary) / 0.5)",
        "card-hover": "0 25px 50px -12px hsl(var(--primary) / 0.25)",
      },
    },
  },
